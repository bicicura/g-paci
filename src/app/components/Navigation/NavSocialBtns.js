const NavSocialBtns = props => {
  return (
    ...
    >
      <div className="cursor-pointer hover:underline hover:font-bold hover:text-purple-500 hover:fill-black">
        <a
          target="_blank"
      ...
      <button
        ...
        } cursor-pointer hover:underline hover:font-bold w-[2.5rem] lg:w-13 `}
      >
